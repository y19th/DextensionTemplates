...
class DextensionEventsTemplate : DextensionAction() {
    ...
    override fun onAction(event: AnActionEvent, input: String, directory: PsiDirectory, option: DependencyInjection) {
        directory.apply {
            ...
            createFolder(Folder.Ui) { ui ->
                ui.createFile(File.Component(input, ScreenOption.Event))
                ui.createFile(File.Content(input, ScreenOption.Event))
